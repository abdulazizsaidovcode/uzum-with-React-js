                    ...
                    <div className=" bg-white overflow-hidden ">
                        <div className="md:flex w-full">
                            <div className='w-full'>
                                ...
                                <div className="flex justify-between items-center mt-2">
                                    <div className='flex text-gray-400'>
                                        <div className="text-yellow-400 text-xs flex">
                                            <p>&#9733;</p>
                                            <p className='text-gray-400 ml-2'> 5.0</p>
                                        </div>
                                ...
                                <div className="uppercase tracking-wide text-sm  font-semibold mt-7">
                                    <p>{product.name}</p>
                                </div>
                                ...
                                {/* Installment */}
                                <div className="bg-slate-200 p-3 flex rounded-xl mt-8">
                                ...
                                <div className='flex items-center bg-orange-100 py-3 rounded-lg px-5 mt-6'>
